...
const usersSlice = createSlice({
  ...
  reducers: {
    ...
    addInitialPlayerLetter: (state, action) => {
...
export const { setUsers, addUser, addCurrentPlayer, setInitialTurn, setNextTurn, addInitialPlayerLetter, addLetter } = usersSlice.actions;
